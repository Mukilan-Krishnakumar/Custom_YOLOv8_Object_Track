'''
The following code was created and distributed by Ivan Goncharov with [ModifiedOpenLabelling Repository](https://github.com/ivangrov/ModifiedOpenLabelling)
All rights to the following code belong to Ivan Goncharov. 
'''
...
parser = argparse.ArgumentParser(description='YOLO v8 Bounding Box Tool')
